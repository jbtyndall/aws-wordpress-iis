...
Remove-Item "$iisWebDirectoryPath\$websiteName\wp-config-sample.php" -Force
 
$wpConfig | Out-File -FilePath "$iisWebDirectoryPath\$websiteName\wp-config.php" -Force
...
error_log = C:\tools\php81\php_errors.log
